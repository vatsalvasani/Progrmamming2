...
int Solution::solve(vector<int> &A, int B) {
    ...
    int ans=0;
    cout<<high;
    //Apply Binary Search For Finding Appropriate Height From 1 to 1e6 Find One Value And In Check Function Check For Value
    //wether it give Cutting No. less then neede or more then needed if it give more then needed then increse the height means
